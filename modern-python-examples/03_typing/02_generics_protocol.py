...
b_str = Box("你好")
print("   Box(42).get() =", b_int.get(), type(b_int.get()).__name__)
print("   Box('你好').get() =", b_str.get(), " ← 同一类定义, 装两种类型")
b_int.put(99)
print("   b_int 换装 99 →", b_int.get())
