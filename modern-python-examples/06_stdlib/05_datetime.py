...
print("   date(2026,9,5)    =", d, "   #", type(d).__name__)
print("   time(14,30,0)     =", t, "   #", type(t).__name__)
print("   datetime(...)     =", dt, "   #", type(dt).__name__)
print("   dt.date() 取日期部:", dt.date(), "  dt.time() 取时间部:", dt.time())
print("   date 上做运算(加减天):", date(2026, 9, 5) + timedelta(days=10))
...
print("   → 同一瞬间钟面差 2 小时, 偏移分别为 0 / +8 / +6 小时")
...
print("\n6) fromisoformat 解析 API 返回的时间文本:")
msg_time = datetime.fromisoformat("2026-09-04T10:00:00")   # 无时区
print("   '2026-09-04T10:00:00' →", msg_time)
