...
print("1) 闭包基本形态:")
print("   outer(5) 生成的函数加 10:", add5(10))
print("   outer(100) 生成的函数加 10:", add100(10))

# 验证环境: 闭包细胞(cell)里有 x = 100
print("   闭包里封存的变量(名称->值):", add100.__closure__[0].cell_contents)
print("   (.__closure__ 是教学观察用; 生产代码别用这个属性)")
...
print("\n2) nonlocal 计数器:")
print("   c1():", c1(), c1(), c1(), "… c2() 从 10 开始:", c2(), c2())
print("   两个计数器环境独立, 互不影响")

# 对比: 全局变量也能计数, 但全局污染 + 多实例互斥 —— 闭包是"局部全局变量"
print("   (c1 和 c2 互不干扰 —— 这正是闭包 vs 全局变量的意义)")
...
print("\n4) 延迟求值:")
print("   ", f1(2.5), "|", f2(42))
print("   好处: 模式只写一次, 用了再算; 类似场景还有惰性加载配置/连接")
...
by16 = make_math(16)
print("\n6) 偏函数视角:")
print("   3 的倍数表:", [by3(n) for n in range(1, 6)])
print("   16 的倍数第一行:", [by16(n) for n in range(1, 4)])
